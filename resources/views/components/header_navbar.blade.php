...
<nav class="bg-white text-[#1b1b18] dark:text-black flex items-center lg:justify-center h-26 flex-col drop-shadow-md">
    {{-- Top --}}
    <div class="bg-b1 text-white font-normal text-[13px] flex flex-row items-center justify-between py-2 px-8 h-fit w-full transition-opacity opacity-100 duration-750 starting:opacity-0">
        ...
        <div class="flex items-center justify-center gap-4.5">
            <div class="flex flex-row items-center justify-center gap-4.5">
                <a href="https://www.instagram.com/telkomindonesia/" target="_blank">
                ...
                <a href="https://www.facebook.com/TelkomIndonesia/" target="_blank">
    ...
    {{-- Bottom --}}
    <div class="flex items-center justify-between w-full transition-opacity opacity-100 duration-750 lg:grow py-2 px-8 starting:opacity-0">
        {{-- Logo --}}
        <a href="{{ route('beranda') }}" class="flex flex-row items-center justify-center gap-2">
            <div class="flex items-center justify-center gap-5 bg-b1 text-white p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 1024 1024">
                    <path d="M0 0h1024v1024H0z" fill="none" />
                ...
                <h1 class="font-bold font-fraunces text-[20px]">    
                Pulihkan
            </h1>
        </a>

        {{-- Navigation --}}
        <div class="flex items-center justify-center gap-5 opacity-100 transition-opacity duration-750 starting:opacity-0">
            <a href="{{ route('beranda') }}" class="{{ request()->routeIs('beranda')
            ? 'text-b1 border-b-2 border-g1'
            : 'text-b4 hover:text-b1' }}"
            font-normal text-[13px] transition-colors duration-500>
                Beranda
            </a>

            <a href="{{ route('event') }}" class="{{ request()->routeIs('event')
            ? 'text-b1 border-b-2 border-g1'
            : 'text-b4 hover:text-b1' }}"
            font-normal text-[13px] transition-colors duration-500>
                Event
            ...
            <a href="{{ route('layanan') }}" class="{{ request()->routeIs('layanan')
            ? 'text-b1 border-b-2 border-g1'
            : 'text-b4 hover:text-b1' }}"
            font-normal text-[13px] transition-colors duration-500>
                Layanan
            ...
            <a href="{{ route('testimoni') }}" class="{{ request()->routeIs('testimoni')
            ? 'text-b1 border-b-2 border-g1'
            : 'text-b4 hover:text-b1' }}"
            font-normal text-[13px] transition-colors duration-500>
                Testimoni
        ...
        {{-- WA Button --}}
        <div>
            <a href="https://wa.me/62xxxxxxxxxxx?text=halo, chat ini dikirim melalui tombol pada website!%0ANama: [Nama]" target="_blank" class="inline-flex items-center gap-2 rounded-3xl bg-b1 px-4 py-2 text-white transition hover:opacity-90">
                <span class="font-normal text-[13px]">Booking Via</span>
                <div class="text-[#25D366] flex items-center justify-center gap-1">
